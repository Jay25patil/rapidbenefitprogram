...
window.App = {
  ...
  refreshBalance1: function() {
    ...
    SmartCurrency.deployed().then(function(instance) {  
      meta = instance;
      return meta.checkshares.call(account, {from: account});
    }).then(function(value) {
  ...
  refreshBalance2: function() {
    ...
    SmartCurrency.deployed().then(function(instance) {  
      meta = instance;
      return meta.checkleaves.call(account, {from: account});
    }).then(function(value) {
    ...
    SmartCurrency.deployed().then(function(instance) {
      rapid= instance;
      return rapid.SendCoins(receiver, amount, {from: account});
    }).then(function(value) {
  ...
  SendShares: function() {
   ...
   checkShares: function() {
    ...
    SmartCurrency.deployed().then(function(instance) {
      ...
      return rapid.checkshares.call(shareAddress, {from: account});
    }).then(function(value) {
